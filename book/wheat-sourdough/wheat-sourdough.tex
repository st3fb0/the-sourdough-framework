...
\begin{figure}[!htb]
  ...
  \caption{The process of checking your sourdough starter when making wheat-based dough. In practice,
  I~frequently use a stiff sourdough starter. The stiff starter features enhanced yeast activity. In that case, you can
  use the same ratios as shown in the chart except for the water quantity. The stiff starter has a hydration of 50 to~60 
  percent. So, you would have half the shown water quantities, i.e., if the chart shows 100~g of water, use 50 to 60~g of water
...
\begin{itemize}
  \item[$\circ$] 400 g of bread flour
  \item[$\circ$] 100 g of whole wheat flour
...
\begin{itemize}
  \item[$\circ$] 1800 g of bread flour
  \item[$\circ$] 200 g of whole wheat flour
